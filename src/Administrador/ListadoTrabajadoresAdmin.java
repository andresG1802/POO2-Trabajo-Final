 ...
 * @author julianquispe
 */
public class ListadoTrabajadoresAdmin extends javax.swing.JFrame {

    /**
     * Creates new form ListadoTrabajadores
     */
    public ListadoTrabajadoresAdmin() {
        initComponents();
        listar();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListadoTrabajadoresAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListadoTrabajadoresAdmin().setVisible(true);
            }
        });
    }
